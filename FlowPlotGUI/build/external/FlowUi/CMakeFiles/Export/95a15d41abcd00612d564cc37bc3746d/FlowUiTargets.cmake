...
foreach(_cmake_expected_target IN ITEMS FlowUi::FlowUi FlowUi::artery)
...
# Create imported target FlowUi::FlowUi
add_library(FlowUi::FlowUi STATIC IMPORTED)

set_target_properties(FlowUi::FlowUi PROPERTIES
  INTERFACE_COMPILE_DEFINITIONS "FLOWUI_RUNTIME_FONT_BAKING=1;FLOWUI_PUBLIC_VULKAN_INTEROP=1;FLOWUI_INCLUDE_ICON_MANAGER=1"
  ...
  INTERFACE_LINK_LIBRARIES "Vulkan::Vulkan;glfw;FlowUi::artery;\$<LINK_ONLY:plutosvg::plutosvg>;\$<LINK_ONLY:>"
  INTERFACE_SYSTEM_INCLUDE_DIRECTORIES "include/external"
)

# Create imported target FlowUi::artery
add_library(FlowUi::artery INTERFACE IMPORTED)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/FlowUiTargets-*.cmake")
...
foreach(_target "plutosvg::plutosvg" )
