...
| --- | --- | --- | --- |
| 🍎 **macOS** | DMG | [Download for macOS](https://github.com/Manwe314/FlowPlot/releases/download/v0.9.10/FlowPlotGUI-0.9.10-macOS.dmg) | Open the DMG and drag `FlowPlotGUI.app` to Applications. See the macOS note below. |
| 🪟 **Windows** | Installer (recommended) | [Download installer](https://github.com/Manwe314/FlowPlot/releases/download/v0.9.10/FlowPlotGUI-0.9.10-Windows.exe) | Run the installer. |
...
| 🐧 **Linux** | AppImage (recommended) | [Download AppImage](https://github.com/Manwe314/FlowPlot/releases/download/v0.9.10/FlowPlotGUI-0.9.10-x86_64.AppImage) | Make it executable, then run it. |
| 🐧 **Linux** | Debian package | [Download `.deb`](https://github.com/Manwe314/FlowPlot/releases/download/v0.9.10/flowplotgui_0.9.10_amd64.deb) | Install it with your distribution's package installer. |
